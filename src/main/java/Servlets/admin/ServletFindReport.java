 ...
 */
@WebServlet(name = "/findReport")
public class ServletFindReport extends HttpServlet {

    public static Logger logger = Logger.getLogger("ServletFindReport");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        RequestDispatcher dispatcher = request.getRequestDispatcher("/showReport");
