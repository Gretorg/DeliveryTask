...
@WebServlet(name = "/showPaginationOrderBy")
public class ServletPaginationOrderBy extends HttpServlet {


    public static Logger logger = Logger.getLogger("ServletPaginationOrderBy");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            deliveryList = dbManager.findUsersOrderBy(connection, start);
